...
import bg from "../../../src/asset/bg.jpg";
        ...
        <Form noValidate validated={validated} onSubmit={handleSubmit}>
          <Form.Group className="mb-3" controlId="NPM">
            ...
            <Form.Control
              ...
              maxLength={10}
            />
            <Form.Control.Feedback>Sudah Benar!</Form.Control.Feedback>
            <Form.Control.Feedback type="invalid">
              Minimal 10 Digit NPM
          ...
          <div className="d-flex justify-content-between">
            ...
            <Form.Group className="mb-3 me-2" controlId="MName">
              ...
              />
              <Form.Control.Feedback>Boleh Dikosongkan!</Form.Control.Feedback>
            </Form.Group>
